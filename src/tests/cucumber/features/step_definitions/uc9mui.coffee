...
module.exports = ()->
  ...
  @Then /^I see my trip on MUI$/, (table)->
    ...
    expect(client.getText("[data-cucumber='trips-list'] div:nth-child(5) span div div div:nth-child(1) div:nth-child(1) span:nth-child(1)")).toEqual(table.hashes()[0].fromAddress)
